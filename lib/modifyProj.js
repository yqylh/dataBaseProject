exports.modifyProj = async(req, res) =>{
    ...
    try {
        ...
        await new Promise(resolve=>{
            mysql.ProjectQuery(req.body.projId, ans=>{
                if (ans[0] == undefined) throw new Error('queryError');
                mysql.ProjectUpdate(req.body.title, req.body.type, new Date(req.body.endTime), ans[0].article_id, ans[0].qn_id, ans[0].proj_id);
